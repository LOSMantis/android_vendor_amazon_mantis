...
CUSTOM_KERNEL_LCM = nt35595_fhd_dsi_cmd_truly_8163
...
CUSTOM_UBOOT_LCM = nt35595_fhd_dsi_cmd_truly_8163
...
LCM_HEIGHT = 1920
LCM_WIDTH = 1080
LINUX_KERNEL_VERSION = kernel/mediatek/mt8695/4.4
...
MTK_BUILD_VERNO = alps-mp-n2.mp12
MTK_BWC_SUPPORT = no
...
MTK_CAM_VPU_SUPPORT = no
MTK_TUNNEL_PLAYBACK_SUPPORT = yes

MTK_FAIRPLAY_SUPPORT = yes

TARGET_PREBUILT_LK = vendor/amazon/signed-images/mantis/$(TARGET_BUILD_VARIANT)/lk.bin
TARGET_PREBUILT_TEE = vendor/amazon/signed-images/mantis/$(TARGET_BUILD_VARIANT)/tz.img
TARGET_PREBUILT_PRELOADER = vendor/amazon/signed-images/mantis/$(TARGET_BUILD_VARIANT)/preloader.bin

# Support DRM keys backup to key programmed RPMB partition
MTK_EMMC_RPMB_SUPPORT := yes
AMZN_DRMPROV_RPMB_BACKUP := yes

# Enable DRM infield provisioning
# Need to exported AMZN_DRMPROV_INFIELD as a variable for TrustZone build
export AMZN_DRMPROV_INFIELD=yes
